...
import { getProdSolutions } from '@/util/api'
...
export default function ProductionCategoryPage() {
    ...
    const { data: response, loading } = useApi(() => getProdSolutions(category), { deps: [category] });
    ...
    const translations = {
        tr: {
            home: "Anasayfa",
            solutions_title: "Üretim Çözümleri",
            loading: "Yükleniyor...",
        ...
        en: {
            home: "Home",
            solutions_title: "Production Solutions",
            loading: "Loading...",
    ...
    return (
        <Layout>
            <PageHeader
                title={categoryInfo ? t(categoryInfo, 'baslik') : category?.replace('-', ' ')}
                                    ...
                                    <div key={index} className="col-lg-4 col-md-6 mb-4">
                                        <div className="card border-0 rounded-4 shadow-1 hover-up h-100">
                                            <div className="card-body p-5 d-flex flex-column">
                                                ...
                                                <Link href={`/uretim-cozumleri/${category}/${t(item, 'slug')}`} className="btn btn-link text-primary p-0 d-inline-flex align-items-center fw-bold text-decoration-none mt-auto">
                                                    {tr.seeDetails}
